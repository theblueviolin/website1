...
function editRow(index, e) {
    ...
    tr.innerHTML = `
        ...
        <td class="edit-date-col"><input type="date" class="edit-input" id="edit-date-${index}" value="${dateVal}"></td>
        <td class="edit-item-col"><textarea class="edit-input wrap-text" id="edit-name-${index}" rows="2">${e.name}</textarea></td>
        <td class="edit-cat-col">
            <select class="edit-input" id="edit-cat-${index}">
                <option ${e.category==='Grocery'?'selected':''}>Grocery</option>
                <option ${e.category==='Eating Out'?'selected':''}>Eating Out</option>
                <option ${e.category==='Object'?'selected':''}>Object</option>
                <option ${e.category==='Gas'?'selected':''}>Gas</option>
                <option ${e.category==='Bills'?'selected':''}>Bills</option>
            </select>
        </td>
        <td class="edit-amt-col"><input type="number" class="edit-input" id="edit-amt-${index}" value="${e.amount}"></td>
        <td></td>
    `;
}
